...
public class FirebaseManager : Singleton<FirebaseManager>
{
	...
	/*public static void ReportEvent(string message, string paramName, string valueInJSON)
	{
	...
	private void SetupRemoteConfig()
	{
		...
		configDefaults.Add("Timeout_20sec", true);
		configDefaults.Add("Timeout_30sec", false);
		configDefaults.Add("Timeout_45sec", false);
